...
['attribute'=>'Nombre', 'label'=>'Troncales entrantes','format'=>'raw', 'hAlign'=>'left', 'width'=>'240px'],
...
['attribute'=>'Nombre', 'label'=>'Troncales salientes','format'=>'raw', 'hAlign'=>'left', 'width'=>'240px'],
...
<div class="roles-general">
  ...
  <?= Growl::widget([
    ...
    <?=GridView::widget([
      ...
      'panel' => [
      'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-phone-alt"> Troncales entrantes</i>  </h3>'.'De '.$inicio.' a '.$final,
      'type'=>'success',
      'footer'=>false
      ],
      ]);?>  
    ...
    <?=GridView::widget([
      ...
      'panel' => [
      'heading'=>'<h3 class="panel-title"><i class="glyphicon  glyphicon-earphone"> Troncales salientes</i>  </h3>'.'De '.$inicio.' a '.$final,
      'type'=>'danger',
      'footer'=>false
      ],
      ]);?>   
