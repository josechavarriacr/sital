...
['attribute'=>'Nombre', 'label'=>'Clientes entrantes','format'=>'raw', 'hAlign'=>'left', 'width'=>'240px'],
...
['attribute'=>'Nombre', 'label'=>'Clientes salientes','format'=>'raw', 'hAlign'=>'left', 'width'=>'240px'],
['attribute'=>'Numero', 'label'=>'Número','format'=>'raw', 'hAlign'=>'middle', 'width'=>'180px'],
...
<div class="roles-general">
  ...
  <?= Growl::widget([
    ...
    <?=GridView::widget([
      ...
      'panel' => [
      'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-phone-alt"> Clientes entrantes</i>  </h3>'.'De '.$inicio.' a '.$final,
      'type'=>'success',
      'footer'=>false
      ],
      ]);?>  
    ...
    <?=GridView::widget([
      ...
      'panel' => [
      'heading'=>'<h3 class="panel-title"><i class="glyphicon  glyphicon-earphone"> Clientes salientes</i>  </h3>'.'De '.$inicio.' a '.$final,
      'type'=>'danger',
      'footer'=>false
      ],
      ]);?>   
